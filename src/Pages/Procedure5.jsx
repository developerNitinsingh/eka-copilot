        ...
        <div className="flex flex-col items-center gap-7 ">
          ...
          <div className="w-full flex items-center justify-center gap-3 relative ">
            <div className=" w-full flex flex-col items-center gap-4 relative">
              ...
              <div className="flex flex-col mx-auto  text-start gap-5 hover:bg-gradient-to-l from-[#CCD5F8] to-[#98ADFB] pb-10 rounded px-2 w-[263px] absolute  h-[290px] top-7 right-1/4 bg-[#FFFFFF] border ">
