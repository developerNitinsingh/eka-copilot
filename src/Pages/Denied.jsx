...
function Denied() {
  ...
  return (
    <HomeLayout>
      ...
      <div
        className="text-red-600 absolute top-2/4 left-[60%] flex flex-col justify-center items-center -translate-x-2/4 -translate-y-2/4 gap-3 "
        style={style}
      >
        <button className="absolute right-0 top-0 " onClick={closeError}>
          <AiFillCloseCircle />
        </button>
        <img src={denid} alt="" className="w-[368px] h-[368px] " />

        <p className="flex flex-col text-center">
          <span className="font-medium text-[22px] text-[#FD6262]">OH NO!</span>
          <span className="font-normal text-lg text-[#19193D]">
            Unfortunately, the Prior Authorization request has been denied.
          </span>
        </p>
