...
function RequestStarted1_1() {
  return (
    <HomeLayout>
      <div className="min-h-[90vh] my-5 shadow-2xl h-auto w-full flex   flex-col py-5 justify-between mx-auto">
...
export default RequestStarted1_1;
